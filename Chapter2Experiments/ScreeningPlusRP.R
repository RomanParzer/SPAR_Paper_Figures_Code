...
# nrep <- 10^2
# maxnum <- 50
# rMSPE <- array(NA,dim=c(nrep,4,maxnum),dimnames = list(reps=1:nrep,methods=c("Screening","RP_CW","ScrRP_CW","ScrRP"),nummod=1:maxnum))
# for (i in 1:nrep) {
...
#   }
# }
# saveRDS(rMSPE,"./Result_ScrRP_ens.rds")
rMSPE <- readRDS("Result_ScrRP_ens.rds")
...
levels(sum_df_rMSPE$Method ) <- c("Scr_HOLP","RP_CW","ScrRP_CW","ScrRP")
sum_df_rMSPE %>%
