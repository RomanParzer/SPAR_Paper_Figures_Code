...
simulation_settings <- list(n=200, p=c(10000), act_setting="medium", ntest=100, snr=10,  cov_setting="comsym",m=100,beta=mybeta)
...
saveRDS(rMSPE,"./Result_ScrRP_nscreen_SPAR_highp.rds")

# rMSPE <- readRDS("Result_ScrRP_nscreen_SPAR_highp.rds")
# nrep <- dim(rMSPE)[1]
...
# # ggsave("../plots/ScRP_nsc_comsym_medium_no1_wSPAR_highp.pdf", height = 5, width = 8)
# 
# 
